    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-[#0A1128] relative overflow-x-hidden" style={{ fontFamily: "'Raleway', sans-serif" }}>
                ...
                <div className="nebula-blob" style={{ width: 460, height: 360, top: "-10%", left: "-5%", background: "rgba(33,158,188,0.08)" }} />
                ...
                <div className="relative z-20 w-full"><UserNavbar /></div>

                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8">

                    {/* Header */}
                    <div ref={headerRef} className={`text-center mb-8 anim-enter ${headerVisible ? "anim-fade-down" : ""}`}>
